...
Trois références qui reviennent partout, même hors contexte philosophique — approfondies au xref:cercle2:philosophie-et-religions/philosophie.adoc[2^e^ cercle] :
