...
* *éolienne* : énergie éolienne (ex. : énergie éolienne) ;
* *solaire* : énergie solaire (ex. : énergie solaire) ;
* *hydraulique* : énergie hydraulique (ex. : énergie hydraulique) ;
* *géothermique* : énergie géothermique (ex. : énergie géothermique) ;
* *marémotrice* : énergie marémotrice (ex. : énergie marémotrice) ;
* *biomasse* : énergie biomasse (ex. : énergie biomasse) ;
* *hydrogène* : énergie hydrogène (ex. : énergie hydrogène).

Elle peut être aussi (cf. link:https://www.youtube.com/watch?v=HgfcZeGP7BA&t=783s[vidéo du Réveilleur sur Youtube]):

* *primaire* : énergie non transformée (ex. : énergie solaire, énergie éolienne, énergie hydraulique, énergie géothermique, énergie marémotrice, énergie biomasse, énergie hydrogène) ;
* *secondaire* : énergie transformée (ex. : énergie électrique, énergie thermique, énergie mécanique, énergie chimique, énergie nucléaire).
* *finale* : énergie utilisée par l'homme (ex. : énergie électrique, énergie thermique, énergie mécanique, énergie chimique, énergie nucléaire) ;
* *utile* : énergie utilisée par l'homme pour produire un travail (ex. : énergie électrique, énergie thermique, énergie mécanique, énergie chimique, énergie nucléaire).
