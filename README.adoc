...
Ma documentation de culture générale est accessible en ouvrant link:content/build/antora/index.html[] avec un navigateur web.

Si le dossier `/build` n'existe pas, il faut générer la documentation.
Pour ce faire, on peut exécuter la commande suivante depuis le dossier `/content` :
