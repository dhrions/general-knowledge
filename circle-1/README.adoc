...
Les DALY mesurent le nombre de jours perdus en bonne santé.
...
* Deux années de vie avec une incapacité de 50 %.

Comparativement à la mortalité, les DALY permettent de prendre en compte les incapacités et les maladies chroniques.
